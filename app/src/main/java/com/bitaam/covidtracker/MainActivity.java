package com.bitaam.covidtracker;
...
import com.bitaam.covidtracker.utility.BgMediaWebView;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.searchItem:
                webView.loadUrl("https://bing.com/covid/local/india");
                break;
        }
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            ...
            new AlertDialog.Builder(this).setTitle("Internet not connected").setMessage("Turn on internet and reopen app.")
                    .setCancelable(false)
